...
public class ArtGalleryofOntarioRegular extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_art_galleryof_ontario_regular);
